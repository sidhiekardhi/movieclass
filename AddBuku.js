...
export class AddBuku extends Component {
    ...
    handleAdd(){
        ...
        axios.post('http://192.168.0.106:8080/buku/addBuku',this.state)
        .then( (response) => {
    ...
    render() {
        return (
            <View>
                ...
                <TextInput placeholder="Halaman Buku" onChangeText={(data)=>{this.setState({halamanBuku:parseInt(data)})}}/>
